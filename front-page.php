...
?>      
        ...
        <section class="banner section">
          <div class="container">
            <div class="banner__info">
              <h1 class="banner__title section__title">the sunset</h1>
              <p class="banner__description">Free PSD portfolio template</p>
            </div><a class="banner__scroll scroll" href="#about">
              <svg class="scroll__mouse">
                <use xlink:href="static/images/svg/symbol/sprite.svg#mouse"></use>
              </svg>
        ...
        <section class="about section">
          <div class="container">
            <div class="about__info">
              <h2 class="about__title section__title">hi there!</h2><img class="about__image" src="static/images/content/about/author.png">
              <p class="about__description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus adipisci alias, autem consectetur earum fugit iusto? Dolorum ea enim error et eum, iusto quidem vitae voluptate!</p>
            </div>
          </div>
        </section>
        <section class="works section">
          ...
          <div class="works__list">
            <div class="works__item work">
              <div class="work__header"><img class="work__img" src="static/images/content/works/work-1.png"><a class="work__button button" href="#">case study<span class="button__arrow-right">&rarr;</span></a></div>
            ...
            <div class="works__item work">
              <div class="work__header"><img class="work__img" src="static/images/content/works/work-2.png"><a class="work__button button" href="#">case study<span class="button__arrow-right">&rarr;</span></a></div>
              <div class="work__info">
            ...
            <div class="works__item work">
              <div class="work__header"><img class="work__img" src="static/images/content/works/work-3.png"><a class="work__button button" href="#">case study<span class="button__arrow-right">&rarr;</span></a></div>
              <div class="work__info">
                <div class="work__title">GOTHIC MOUNTAINS #1</div>
                <div class="work__description">Landscape photography</div>
              </div>
            ...
            <div class="works__item work">
              <div class="work__header"><img class="work__img" src="static/images/content/works/work-4.png"><a class="work__button button" href="#">case study<span class="button__arrow-right">&rarr;</span></a></div>
              <div class="work__info">
            ...
            <div class="works__item work">
              <div class="work__header"><img class="work__img" src="static/images/content/works/work-5.png"><a class="work__button button" href="#">case study<span class="button__arrow-right">&rarr;</span></a></div>
              <div class="work__info">
                <div class="work__title">BACON IPSUM DOLOR</div>
                <div class="work__description">Nature photography</div>
              </div>
            ...
            <div class="works__item work">
              <div class="work__header"><img class="work__img" src="static/images/content/works/work-6.png"><a class="work__button button" href="#">case study<span class="button__arrow-right">&rarr;</span></a></div>
              <div class="work__info">
                <div class="work__title">BACON IPSUM DOLOR</div>
                <div class="work__description">Nature photography</div>
              </div>
            ...
            <div class="trends__list">
              <div class="trends__item">
                <svg class="trends__image">
                  <use xlink:href="static/images/svg/symbol/sprite.svg#web"></use>
                </svg>
              ...
              <div class="trends__item">
                <svg class="trends__image">
                  <use xlink:href="static/images/svg/symbol/sprite.svg#ux"></use>
                </svg>
              ...
              <div class="trends__item">
                <svg class="trends__image">
                  <use xlink:href="static/images/svg/symbol/sprite.svg#promo"></use>
                </svg>
            ...
            <div class="things__list">
              <div class="things__item">
                <svg class="things__icon">
                  <use xlink:href="static/images/svg/symbol/sprite.svg#guitar"></use>
                </svg>
              </div>
              <div class="things__item">
                <svg class="things__icon">
                  <use xlink:href="static/images/svg/symbol/sprite.svg#palette"></use>
                </svg>
              </div>
              <div class="things__item">
                <svg class="things__icon">
                  <use xlink:href="static/images/svg/symbol/sprite.svg#food"></use>
                </svg>
              </div>
              <div class="things__item">
                <svg class="things__icon">
                  <use xlink:href="static/images/svg/symbol/sprite.svg#puzzle"></use>
                </svg>
              </div>
            </div>
          </div>
              ...
              <div class="contacts__column">
                <div class="contacts__row">
                  <svg class="contacts__icon">
                    <use xlink:href="static/images/svg/symbol/sprite.svg#email"></use>
                  </svg>
                  <div class="contacts__text">email</div>
                </div>
                <div class="contacts__row">
                  <svg class="contacts__icon">
      ...
      <footer class="footer">
        <div class="container">
          <div class="footer__social social"><a class="social__item" href="#">
              <svg class="social__icon">
                <use xlink:href="static/images/svg/symbol/sprite.svg#behance"></use>
              </svg></a><a class="social__item" href="#">
              <svg class="social__icon">
                <use xlink:href="static/images/svg/symbol/sprite.svg#dribbble"></use>
              </svg></a><a class="social__item" href="#">
              <svg class="social__icon">
